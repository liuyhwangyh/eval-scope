...
async def dispatch_requests_worker(request_queue: asyncio.Queue, args):
    input_output_processor = get_input_output_processor(args.parser).PerfPlugin()
...
async def statistic_benchmark_metric_worker(benchmark_data_queue: asyncio.Queue, args):
    ...
    response_parser = get_input_output_processor(args.parser).PerfPlugin()
    if args.name:
...
def add_argument(parser: argparse.ArgumentParser):
    ...
    parser.add_argument("--parser",
                        ...
                        help="Specify the request/response processor, the prompt generator, current support,"
                             "you can define your custom parser, reference llm_parser_base.py,"
